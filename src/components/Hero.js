            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <p>
                    A JS backend developer focused on building fast, scalable, 
                    and secure server-side applications using Node.js 
                    and modern frameworks.
                  </p>
                </div>
                <div className="mt-10 flex items-center justify-center gap-x-4">
                  <a href="https://www.linkedin.com/in/onesime-malkiel-adje-a3a479279" rel="noreferrer" className="btn btn-outline btn-square">
                    <svg
                  ...
                  <a href="https://github.com/adjemalkiel" rel="noreferrer" className="btn btn-outline btn-square">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-8 w-8"
                      fill="currentColor"
